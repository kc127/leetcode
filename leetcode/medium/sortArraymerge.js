...
var merge = (leftArray, rightArray) => {
  ...
  // when both arrays have some items left in them
  while (leftIndex < leftArray.length && rightIndex < rightArray.length) {
    if (leftArray[leftIndex] < rightArray[rightIndex]) {
      mergedArray[mergedArrayIndex] = leftArray[leftIndex];
      leftIndex++;
    } else {
      mergedArray[mergedArrayIndex] = rightArray[rightIndex];
      rightIndex++;
    }
    mergedArrayIndex++;
  }

  // when left array has items left after exhausting second array
  ...
  //when right array has items left after exhausting first array
